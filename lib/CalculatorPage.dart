...
class CalculatorPage extends StatefulWidget{
  ...
  CalculatorPage(this.selected_day,this.events_map,this.prefs);
  @override
...
class _CalculatorPageState extends State<CalculatorPage>
{
  ...
  final Map<DateTime,List<dynamic>> events_map;
  _CalculatorPageState(this.selected_day,this.events_map,this.prefs);
                            ...
                            new MaterialPageRoute(
                                builder:
                                  (BuildContext context) =>
                                      CalendarPage.events(events_map,prefs)
                            )
                        );
