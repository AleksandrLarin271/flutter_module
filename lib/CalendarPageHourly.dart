...
import 'package:flutter_module/CalendarPagePerdiem.dart';
...
class CalendarPageHourly extends StatefulWidget{
  ...
  @override
  State createState()=>(events_map==null)?_CalendarPageHourlyState.prefs(prefs):_CalendarPageHourlyState.events(events_map,prefs);
}

class _CalendarPageHourlyState extends State<CalendarPageHourly>
{
  SharedPreferences prefs;
  ...
  CalendarController _controller;
    ...
    void initState(){
      ...
      if(prefs_calculator!=null){
        ...
        setState(() {
          prefs.setString("events_hourly", json.encode((encodeMap(_events))));
        });
      }else {
        initPrefs();
     ...
     initPrefs() async{
      ...
      setState(() {
        _events = Map<DateTime,List<dynamic>>.from(decodeMap(json.decode(prefs.getString("events_hourly") ?? "{}")));
      });
    }
       ...
       return Scaffold(
                              ...
                              child: FlatButton(
                                ...
                                onPressed:(){
                                  Navigator.of(context).push(new MaterialPageRoute(builder:
                                      (BuildContext context) => ResultPageHourly()));
                                } ,
                            )
                          )
                      ),
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: (){
            ...
            print(prefs.getString("hourly"));

            print("CalculatorPage");
            Navigator.of(context).push(new MaterialPageRoute(builder:
                (BuildContext context) => CalculatorPageHourly(
