...
class ResultPageHourly extends StatefulWidget {
  SharedPreferences prefs;
  ResultPageHourly.prefs(this.prefs);
  ResultPageHourly();
  @override
  State createState()=>_ResultPageHourlyState();
}

class _ResultPageHourlyState extends State<ResultPageHourly> {

  SharedPreferences prefs;
  Map<DateTime,List<dynamic>> _events;
  _ResultPageHourlyState.prefs(this.prefs);
  _ResultPageHourlyState();
  ...
  initPrefs() async{
    ...
    print(prefs.getString("events_hourly"));
                          ...
                          child:FlatButton(
                                ...
                                onPressed: (){
                                  ...
                                  push(new MaterialPageRoute(
                                      builder:(BuildContext context) =>CalendarPageHourly()
                                      )
                                  );
                                },
                            )
